...
const ClientReview = () => {
    return (
        <div className="lg:mx-44">
            <p className="text-3xl font-bold my-10 text-center  text-blue-500">What Our Customer Tell About Us</p>
            ...
            <div className='flex p-10 mx-20' data-aos="zoom-in-down" data-aos-easing="ease-in">
                ...
                <div>
                    <p className='text-3xl w-96 text-blue-500 my-auto'><i>A satisfied customer is the best bussiness stategy of all</i></p>
